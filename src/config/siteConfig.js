export const siteConfig = {
  businessName: "MUNNA DYEING PRINTING",
  shortName: "MUNNA",
  ...
  seo: {
    title: "Munna Dyeing Printing | Fabric Dyeing & Printing in Hyderabad",
    description: "Munna Dyeing Printing provides expert fabric dyeing, screen printing, Shibori, block print, Kalamkari, and Batik in NTR Nagar, Pragathi Nagar, Nizampet, Hyderabad. All dyeable fabric, own manufacturing.",
    keywords: "Munna Dyeing Printing, fabric dyeing Hyderabad, screen printing Nizampet, Shibori tie dye, block print fabric, Kalamkari Hyderabad, Batik fabric, dyeable fabric wholesale"
  }
};
